...
import { fetchAccessoriesGlasses } from '../Api';
import styles from './AccessoriesGlassesPage.module.scss';

export const AccessoriesGlassesPage: React.FC = () => {
  ...
  useEffect(() => {
    fetchAccessoriesGlasses(getApiRoot(), filter, sort, search).then(response => {
