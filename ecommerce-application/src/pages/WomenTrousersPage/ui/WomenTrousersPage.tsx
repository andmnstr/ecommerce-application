...
import { fetchWomenTrousers } from '../Api';
import styles from './WomenTrousersPage.module.scss';

export const WomenTrousersPage: React.FC = () => {
  ...
  useEffect(() => {
    fetchWomenTrousers(getApiRoot(), filter, sort, search).then(response => {
