...
import { fetchAccessoriesBags } from '../Api';
import styles from './AccessoriesBagsPage.module.scss';

export const AccessoriesBagsPage: React.FC = () => {
  ...
  useEffect(() => {
    fetchAccessoriesBags(getApiRoot(), filter, sort, search).then(response => {
