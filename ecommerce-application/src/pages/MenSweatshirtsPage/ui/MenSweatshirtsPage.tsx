...
import { fetchMenSweatshirts } from '../Api';
import styles from './MenSweatshirtsPage.module.scss';

export const MenSweatshirtsPage: React.FC = () => {
  ...
  useEffect(() => {
    fetchMenSweatshirts(getApiRoot(), filter, sort, search).then(response => {
