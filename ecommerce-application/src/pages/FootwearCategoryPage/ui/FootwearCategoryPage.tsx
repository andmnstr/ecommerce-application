...
import { fetchFootwearProducts } from '../Api';
import styles from './FootwearCategoryPage.module.scss';

export const FootwearCategoryPage: React.FC = () => {
  ...
  useEffect(() => {
    fetchFootwearProducts(getApiRoot(), filter, sort, search).then(response => {
