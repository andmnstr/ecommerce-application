...
import { fetchFootwearShoes } from '../Api';
import styles from './FootwearShoesPage.module.scss';

export const FootwearShoesPage: React.FC = () => {
  ...
  useEffect(() => {
    fetchFootwearShoes(getApiRoot(), filter, sort, search).then(response => {
