...
import { fetchAccessoriesProducts } from '../Api';
import styles from './AccessoriesCategoryPage.module.scss';

export const AccessoriesCategoryPage: React.FC = () => {
  ...
  useEffect(() => {
    fetchAccessoriesProducts(getApiRoot(), filter, sort, search).then(response => {
